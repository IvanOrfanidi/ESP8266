...
conn:on("connection", function(conn)
    ...
    print("Send data...")
    print("GET /update?key="..TSKEY.."&field1="..tBMP.."&field2="..phgBMP.."&field3="..tDS.."&field4="..tDHT.."&field5="..hDHT.."\r\n")
    conn:send("GET /update?key="..TSKEY.."&field1="..tBMP.."&field2="..phgBMP.."&field3="..tDS.."&field4="..tDHT.."&field5="..hDHT.."\r\n")
end)
